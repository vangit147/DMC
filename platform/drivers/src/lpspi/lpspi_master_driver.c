                                  ...
                                  uint32_t delaySCKtoPCS, uint32_t delayPCStoSCK)
{
    ...
    /* Instantiate local variable of type LPSPI_Type and point to global state */
    LPSPI_Type *base = g_lpspiBase[instance];
    status_t errorCode = STATUS_SUCCESS;
    ...
    (void)LPSPI_SetDelay(base, LPSPI_SCK_TO_PCS, delaySCKtoPCS);
    (void)LPSPI_SetDelay(base, LPSPI_PCS_TO_SCK, delayPCStoSCK);
    (void)LPSPI_SetDelay(base, LPSPI_BETWEEN_TRANSFER, delayBetwenTransfers);
    /* Enable module */
    LPSPI_Enable(base);
    return errorCode;
}
    ...
    else
    {
        ...
        switch(lpspiState->bytesPerFrame)
        {
            ...
            case 2:
                ...
                break;
            case 4:
                dmaTransferSize = EDMA_TRANSFER_SIZE_4B;
                break;
            default :
                dmaTransferSize = EDMA_TRANSFER_SIZE_4B;
                break;
