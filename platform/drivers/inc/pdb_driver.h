...
typedef enum
{
    PDB_CLK_PREDIV_BY_1   = 0U, /*!< Counting divided by 1 x prescaler multiplication factor (selected by MULT). @internal gui name="1" */
    PDB_CLK_PREDIV_BY_2   = 1U, /*!< Counting divided by 2 x prescaler multiplication factor (selected by MULT). @internal gui name="2" */
    PDB_CLK_PREDIV_BY_4   = 2U, /*!< Counting divided by 4 x prescaler multiplication factor (selected by MULT). @internal gui name="4" */
    PDB_CLK_PREDIV_BY_8   = 3U, /*!< Counting divided by 8 x prescaler multiplication factor (selected by MULT). @internal gui name="8" */
    PDB_CLK_PREDIV_BY_16  = 4U, /*!< Counting divided by 16 x prescaler multiplication factor (selected by MULT). @internal gui name="16" */
    PDB_CLK_PREDIV_BY_32  = 5U, /*!< Counting divided by 32 x prescaler multiplication factor (selected by MULT). @internal gui name="32" */
    PDB_CLK_PREDIV_BY_64  = 6U, /*!< Counting divided by 64 x prescaler multiplication factor (selected by MULT). @internal gui name="64" */
    PDB_CLK_PREDIV_BY_128 = 7U  /*!< Counting divided by 128 x prescaler multiplication factor (selected by MULT). @internal gui name="128" */
...
typedef struct
{
    ...
    bool                            intEnable;                /*!< Enable the interrupt for timer.
                                                                   \nNote: interrupt is generated only if DMA is disabled. @internal gui name="Interrupt" id="Interrupt" */
#if FEATURE_PDB_HAS_INSTANCE_BACKTOBACK
    bool                            instanceBackToBackEnable;       /*!< Enable the instance back to back mode between PDB0 CH0 and PDB1 CH0 pre-triggers, forming a ring (PDB0_CH0_pretrigger7 -> PDB1_CH0_pretrigger0 and PDB1_CH0_pretrigger7 -> PDB0_CH0_pretrigger0).
                                                                         ...
                                                                         \nNote: must not be enabled simultaneously with inter-channel back to back on any PDB instance.   @internal gui name="Instance Back-To-Back mode" id="InstanceBackToBackMode"*/
#endif /* FEATURE_PDB_HAS_INSTANCE_BACKTOBACK */
#if FEATURE_PDB_HAS_INTERCHANNEL_BACKTOBACK
    bool                            interchannelBackToBackEnable;   /*!< Enable the inter-channel back to back mode between PDBx CH0 and PDBx CH1 pre-triggers, forming a ring (PDBx_CH0_pretrigger7 -> PDBx_CH1_pretrigger0 and PDBx_CH1_pretrigger7 -> PDBx_CH0_pretrigger0).
                                                                         \nNote: this configuration is dedicated to each PDB instance.
                                                                         \nNote: must not be enabled simultaneously with instance back to back on any PDB instance.  @internal gui name="Inter-channel Back-To-Back mode" id="InstanceBackToBackMode"*/
...
typedef struct
{
    ...
    bool preTriggerBackToBackEnable; /*!< Enable the back to back mode for ADC pre_trigger.
                                          ...
                                          The previous pretrigger for pretriggers with index 0, depend on features instanceBackToBackEnable and interchannelBackToBackEnable. @internal gui name="Back-To-Back mode" id="AdcBackToBackMode" */
 ...
 *
 * This function initializes the PDB counter, input triggers and general pre-trigger settings.
...
/*!
 * @brief Gets the current value of the PDB counter.
 *
 ...
 * Important note: any pretrigger which is enabled and has the trigger output enabled (preTriggerOutputEnable
