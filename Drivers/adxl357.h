...
// Flash操作时的中断控制标志
// 控制Flash操作期间是否禁用ADXL357和IAM20680HT传感器中断
// 1-启用中断控制：Flash操作前禁用传感器中断，操作后重新启用（推荐）
// 0-禁用中断控制：Flash操作期间不控制传感器中断状态
#define ADXL357_FLASH_INTERRUPT_CONTROL    1     // Flash操作时的中断控制开关（1-启用，0-禁用）
